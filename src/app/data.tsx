...
export const CategoriasDeProyectos: ProjectCategoryType[] = [
  {
    id: 1,
    titleMB: "Generar",
    title: "Energía",
    description:
      "Esta sección es fundamental para proyectos técnicos que buscan autonomía o ahorro.",
    subtitle: [
      {
        id: 1.1,
        name: "Generación de Energía",
        description:
          "Construcción de cargadores solares, aerogeneradores caseros, paneles térmicos, etc.",
      },
      {
        id: 1.2,
        name: "Ahorro Energético",
        description:
          "Proyectos de aislamiento térmico, iluminación LED DIY o sensores de presencia.",
      },
      {
        id: 1.3,
        name: "Biocombustibles",
        description: "Generación de biogás a pequeña escala o biodiesel.",
      },
    ],
    image: {
      src: "/solarPanel.svg",
  ...
  },
  {
    ...
    titleMB: "Captar",
    title: "Agua",
    description: "Proyectos enfocados en el recurso más vital.",
    subtitle: [
      {
        id: 2.1,
        name: "Captación Pluvial",
        description: "Sistemas para recoger y filtrar agua de lluvia.",
      },
      {
        id: 2.2,
        name: "Tratamiento de Aguas Grises",
        description:
          "Filtros naturales para reutilizar el agua utilizada en casa.",
      },
      {
        id: 2.3,
        name: "Riego Inteligente",
        description: "Sistemas de goteo solar o automatizados con Arduino.",
      },
    ],
    image: {
      src: "/droplet.svg",
  ...
  },
  {
    ...
    titleMB: "Recuperar",
    title: "Residuos",
    description: "Aquí es donde la basura se convierte en recurso.",
    subtitle: [
      {
        id: 3.1,
        name: "Reciclaje Creativo",
        description:
          "Transformación de plástico, vidrio o metal en objetos útiles.",
      },
      {
        id: 3.2,
        name: "Compostaje",
        description:
          "Guías para vermicomposteras (con lombrices) o composteras de jardín.",
      },
      {
        id: 3.3,
        name: "Plásticos Preciosos",
        description: "Técnicas para fundir y moldear plásticos recuperados.",
      },
    ],
    image: {
      src: "/recycle.svg",
  ...
  },
  {
    ...
    description: "Enfocado en el espacio donde vivimos.",
    subtitle: [
      {
        id: 4.1,
        name: "Materiales Ecológicos",
        description: "Ladrillos de adobe, bioplásticos o pinturas naturales.",
      },
      {
        id: 4.2,
        name: "Mobiliario Sostenible",
        description: "Muebles con palets o materiales recuperados.",
      },
      {
        id: 4.3,
        name: "Limpieza y Cosmética Zero Waste",
        description:
          "Recetas de detergentes biodegradables y productos de higiene personal.",
      },
    ],
    image: {
      src: "/carrot.svg",
    ...
    category: Category.BIOCONSTRUCCION,
    projectNumbers: 203,
  },
  {
    id: 5,
    titleMB: "Cultivar",
    title: "Biodiversidad",
    description: "Cultiva tus propios alimentos en espacios pequeños.",
    subtitle: [
      {
        id: 5.1,
        name: "Huertos Urbanos",
        description: "Hidroponía, macetohuertos y cultivo vertical.",
      },
      {
        id: 5.2,
        name: "Refugios de Biodiversidad",
        description: "Hoteles para insectos polinizadores o casas para aves.",
      },
      {
        id: 5.3,
        name: "Conservación de Semillas",
        description: "Técnicas de secado y bancos de semillas caseros.",
      },
    ],
    image: {
      src: "/carrot.svg",
    ...
    category: Category.BIODIVERSIDAD,
    projectNumbers: 203,
  },
];
...
export const ProyectosDestacados: ProyectosDestacadosType[] = [
  {
    ...
    cost: "0",
    difficulty: ProjectDifficulty.MEDIO,
  ...
  {
    id: 7,
    title: "Huerto Vertical en Balcón",
    description:
...
export const TodosLosProyectos: ProyectoType[] = [
  {
    ...
    cost: "$250.00 MXN",
    difficulty: ProjectDifficulty.FACIL,
    completedProjects: 60,
    materialsId: [2, 3],
    steps: [
      {
        title: "Preparar la madera",
        longDescription:
        ...
        shortDescription: ["lijar la madera", "barnizar", "dejar secar"],
        image: {
      ...
      {
        title: "Crear un cuadro con los pallets",
        longDescription:
        ...
        image: { src: "https://i.redd.it/6pprkjgcu9qe1.jpeg", alt: "" },
      },
      {
        title: "Tapa de madera",
        longDescription:
      ...
      {
        title: "Agrega el material orgánico",
        longDescription:
  ...
  },
  {
    ...
    likes: 567,
    comments: 62,
    author: { name: "Ana Torres", avatar: "https://i.pravatar.cc/150?u=ana" },
    cost: "$450.00 MXN",
    difficulty: ProjectDifficulty.FACIL,
    ...
    steps: [
      ...
      {
        title: "Cortar las botellas de pet",
        longDescription:
  ...
  {
    id: 4,
    title: "Horno Solar de Cartón",
    category: Category.ENERGIAS,
    subCategorys: [],

    constructionTime: "1.5 horas",
    descripcion:
    ...
    steps: [
      ...
      {
        title: "Primera Capa de Material",
        longDescription:
  ...
  {
    id: 7,
    title: "Sistema de Compostaje Urbano Sostenible",
    descripcion:
  ...
  {
    id: 9,
    title: "Compostero de Doble Cámara",
    descripcion:
    ...
    steps: [
      {
        title: "Corte de madera",
        longDescription:
          "Corta los listones de madera de pino según las medidas del plano (1x1m).",
        shortDescription: ["Medir", "Cortar", "Lijar"],
        image: { src: "step1.jpg", alt: "Madera cortada" },
      },
      {
        title: "Armado de estructura",
        longDescription:
          "Une los marcos laterales usando tornillos galvanizados para evitar la corrosión.",
        shortDescription: ["Atornillar", "Nivelar"],
        image: { src: "step2.jpg", alt: "Estructura armada" },
      },
      {
        title: "Instalación de malla",
        longDescription:
          "Coloca malla de acero en el fondo para permitir la entrada de microorganismos del suelo.",
        shortDescription: ["Engrapar malla", "Cortar excedentes"],
        image: { src: "step3.jpg", alt: "Base con malla" },
      },
      {
        title: "División central",
        longDescription:
          "Instala la tabla divisoria que permitirá separar el compost maduro del nuevo.",
        shortDescription: ["Fijar división", "Verificar puertas"],
        image: { src: "step4.jpg", alt: "Cámaras separadas" },
      },
    ],
  },
  {
    id: 10,
    title: "Captador de Agua de Lluvia",
    descripcion:
    ...
    materialsId: [12, 15, 20],
    steps: [
      {
        title: "Limpieza de canaletas",
        longDescription:
          "Retira hojas y sedimentos de las canaletas del techo.",
        shortDescription: ["Limpiar", "Revisar fugas"],
        image: { src: "rain1.jpg", alt: "Canaleta limpia" },
      },
      {
        title: "Filtro de primeras aguas",
        longDescription:
          "Instala un tubo desviador para que los primeros 10 litros (sucios) no entren al tanque.",
        shortDescription: ["Instalar derivación", "Pegar PVC"],
        image: { src: "rain2.jpg", alt: "Tubo PVC" },
      },
      {
        title: "Conexión al tanque",
        longDescription:
          "Acopla la bajada de agua al orificio superior del bidón de almacenamiento.",
        shortDescription: ["Sellar unión", "Colocar filtro"],
        image: { src: "rain3.jpg", alt: "Tanque conectado" },
      },
      {
        title: "Instalación de grifo",
        longDescription:
          "Perfora la base del tanque e instala una llave de paso para extraer el agua.",
        shortDescription: ["Perforar", "Poner teflón", "Roscar grifo"],
        image: { src: "rain4.jpg", alt: "Grifo instalado" },
      },
    ],
  },
  {
    id: 11,
    title: "Huerto Vertical de Pared",
    descripcion:
    ...
    steps: [
      {
        title: "Tratamiento del palet",
        longDescription:
          "Lija toda la superficie y aplica un lasur ecológico para protegerlo de la humedad.",
        shortDescription: ["Lijar", "Barnizar"],
        image: { src: "garden1.jpg", alt: "Palet lijado" },
      },
      {
        title: "Forrado de cajones",
        longDescription:
          "Instala malla geotextil en el interior de los huecos para contener la tierra.",
        shortDescription: ["Cortar tela", "Engrapar"],
        image: { src: "garden2.jpg", alt: "Tela negra" },
      },
      {
        title: "Preparación del sustrato",
        longDescription:
          "Mezcla fibra de coco, humus de lombriz y perlita para un drenaje óptimo.",
        shortDescription: ["Mezclar", "Rellenar"],
        image: { src: "garden3.jpg", alt: "Tierra fértil" },
      },
      {
        title: "Siembra",
        longDescription:
          "Trasplanta tus plántulas dejando espacio suficiente entre ellas para que crezcan.",
        shortDescription: ["Plantar", "Regar inicial"],
        image: { src: "garden4.jpg", alt: "Plantas colocadas" },
      },
    ],
  },
  {
    id: 12,
    title: "Hotel de Polinizadores",
    descripcion:
    ...
    category: Category.BIODIVERSIDAD,
    subCategorys: [],
    constructionTime: "5 horas",
    likes: 340,
    comments: 19,
    author: {
      name: "Dr. Fauna",
      avatar: "https://i.pravatar.cc/150?u=fauna",
    },
    cost: "$15 MXN",
    difficulty: ProjectDifficulty.MEDIO,
    completedProjects: 88,
    materialsId: [40, 41, 42, 43],
    steps: [
      {
        title: "Marco exterior",
        longDescription:
          "Crea una casita de madera con techo inclinado para desviar la lluvia.",
        shortDescription: ["Cortar marcos", "Unir piezas"],
        image: { src: "bug1.jpg", alt: "Casita vacía" },
      },
      {
        title: "Secciones internas",
        longDescription:
          "Divide el espacio con maderas finas para crear diferentes 'habitaciones'.",
        shortDescription: ["Hacer divisiones"],
        image: { src: "bug2.jpg", alt: "Celdas internas" },
      },
      {
        title: "Relleno diverso",
        longDescription:
          "Coloca cañas de bambú, piñas de pino, troncos perforados y paja.",
        shortDescription: ["Perforar", "Insertar"],
        image: { src: "bug3.jpg", alt: "Materiales de nido" },
      },
      {
        title: "Ubicación",
        longDescription:
          "Cuelga el hotel a 1.5m de altura orientado al sur en un lugar soleado.",
        shortDescription: ["Colgar", "Orientar"],
        image: { src: "bug4.jpg", alt: "Hotel instalado" },
      },
    ],
  },
  {
    ...
    category: Category.ENERGIAS,
    subCategorys: [],
    constructionTime: "1 hora",
    likes: 512,
    comments: 45,
    author: { name: "Chef Sol", avatar: "https://i.pravatar.cc/150?u=sol" },
    cost: "10 MXN",
    difficulty: ProjectDifficulty.MEDIO,
    completedProjects: 210,
    materialsId: [50, 51, 52],
    steps: [
      {
        title: "Caja dentro de caja",
        longDescription:
          "Coloca una caja pequeña dentro de una grande dejando un espacio para el aislante.",
        shortDescription: ["Encajar", "Centrar"],
        image: { src: "solar1.jpg", alt: "Cajas de cartón" },
      },
      {
        title: "Aislamiento térmico",
        longDescription:
          "Rellena el espacio entre las cajas con papel de periódico arrugado.",
        shortDescription: ["Arrugar papel", "Rellenar"],
        image: { src: "solar2.jpg", alt: "Periódico aislante" },
      },
      {
        title: "Reflectores",
        longDescription:
          "Forra las solapas superiores con papel aluminio de forma que no queden arrugas.",
        shortDescription: ["Pegar aluminio"],
        image: { src: "solar3.jpg", alt: "Aluminio brillante" },
      },
      {
        title: "Cubierta de vidrio",
        longDescription:
          "Coloca un vidrio o plástico transparente sobre la caja interior para crear efecto invernadero.",
        shortDescription: ["Tapar", "Sellar"],
        image: { src: "solar4.jpg", alt: "Horno listo" },
      },
    ],
  },
  {
    id: 14,
    title: "Vermicompostera de Apartamento",
    descripcion:
    ...
    category: Category.RESIDUOS,
    subCategorys: [],
    constructionTime: "40 min",
    likes: 270,
    comments: 14,
    author: {
      name: "Eco Vecino",
      avatar: "https://i.pravatar.cc/150?u=ecov",
    },
    cost: "20 MXN",
    difficulty: ProjectDifficulty.FACIL,
    ...
    steps: [
      {
        title: "Perforación de cubetas",
        longDescription:
          "Haz agujeros pequeños en la base de las cubetas para el drenaje de lixiviados.",
        shortDescription: ["Taladrar", "Limpiar rebabas"],
        image: { src: "worm1.jpg", alt: "Cubeta perforada" },
      },
      {
        title: "Cama de cartón",
        longDescription:
          "Crea una base húmeda con tiras de cartón y papel sin tinta.",
        shortDescription: ["Picar cartón", "Humedecer"],
        image: { src: "worm2.jpg", alt: "Base de papel" },
      },
      {
        title: "Introducción de lombrices",
        longDescription:
          "Coloca el núcleo de lombrices sobre la cama y deja que se entierren solas.",
        shortDescription: ["Soltar lombrices"],
        image: { src: "worm3.jpg", alt: "Lombrices rojas" },
      },
      {
        title: "Primer alimento",
        longDescription:
          "Añade una pequeña cantidad de restos de verdura picada en una esquina.",
        shortDescription: ["Alimentar", "Tapar"],
        image: { src: "worm4.jpg", alt: "Restos orgánicos" },
      },
    ],
  },
  {
    id: 15,
    title: "Bomba de Agua Manual (PVC)",
    descripcion:
    ...
    category: Category.AGUA,
    subCategorys: [],
    constructionTime: "6 horas",
    likes: 150,
    comments: 30,
    author: { name: "Ing. Agua", avatar: "https://i.pravatar.cc/150?u=inga" },
    cost: "30 MXN",
    difficulty: ProjectDifficulty.DIFICIL,
    completedProjects: 15,
    materialsId: [70, 71, 72, 73],
    steps: [
      {
        title: "Cilindro de presión",
        longDescription:
          "Corta el tubo de PVC de 3 pulgadas y lija el interior perfectamente.",
        shortDescription: ["Cortar", "Lijar interior"],
        image: { src: "pump1.jpg", alt: "Tubo PVC ancho" },
      },
      {
        title: "Válvula de pie",
        longDescription:
          "Instala la válvula de retención en la base para que el agua no retroceda.",
        shortDescription: ["Pegar válvula"],
        image: {
      ...
      },
      {
        ...
        shortDescription: ["Armar pistón", "Probar sello"],
        image: { src: "pump3.jpg", alt: "Pistón con goma" },
      },
      {
        title: "Palanca de accionamiento",
        longDescription:
          "Monta una estructura de madera que sirva de apoyo para el brazo de la bomba.",
        shortDescription: ["Construir palanca"],
        image: { src: "pump4.jpg", alt: "Bomba montada" },
      },
    ],
  },
  {
    id: 16,
    title: "Banco de Semillas Comunitario",
    descripcion:
    ...
    likes: 420,
    comments: 50,
    author: { name: "Semillero", avatar: "https://i.pravatar.cc/150?u=semi" },
    cost: "30 MXN",
    difficulty: ProjectDifficulty.FACIL,
    completedProjects: 200,
    materialsId: [80, 81, 82],
    steps: [
      {
        title: "Limpieza y secado",
        longDescription:
          "Extrae las semillas y déjalas secar a la sombra hasta que no tengan humedad.",
        shortDescription: ["Secar", "Limpiar"],
        image: { src: "seed1.jpg", alt: "Semillas secando" },
      },
      {
        title: "Clasificación",
        longDescription: "Separa por especie, variedad y fecha de recolección.",
        shortDescription: ["Etiquetar", "Clasificar"],
        image: { src: "seed2.jpg", alt: "Sobres de papel" },
      },
      {
        title: "Almacenamiento",
        longDescription:
          "Guarda las semillas en frascos de vidrio herméticos con un poco de sílice.",
        shortDescription: ["Envasar", "Sellar"],
        image: { src: "seed3.jpg", alt: "Frascos de vidrio" },
      },
      {
        title: "Registro",
        longDescription:
          "Crea una ficha técnica para cada variedad incluyendo requerimientos de suelo.",
        shortDescription: ["Escribir fichas"],
        image: { src: "seed4.jpg", alt: "Cuaderno de registro" },
      },
    ],
  },
  {
    id: 17,
    title: "Deshidratador Solar de Alimentos",
    descripcion:
    ...
    materialsId: [90, 91, 92, 93],
    steps: [
      {
        title: "Cámara de calor",
        longDescription:
          "Construye una caja con fondo negro para absorber la radiación solar.",
        shortDescription: ["Pintar de negro", "Aislar"],
        image: {
  ...
  {
    id: 18,
    title: "Biodigestor Casero Experimental",
    descripcion:
  ...
  },
  {
    ...
    materialsId: [110, 111, 112, 113],
    steps: [
      {
        title: "Tanque de peces",
        longDescription:
          "Prepara un tanque de al menos 100 litros con aireación constante.",
        shortDescription: ["Oxigenar", "Limpiar"],
        image: { src: "aqua1.jpg", alt: "Acuario" },
      },
      {
        title: "Cama de cultivo",
        longDescription:
          "Instala una bandeja superior llena de arlita o grava volcánica.",
        shortDescription: ["Poner sustrato"],
        image: { src: "aqua2.jpg", alt: "Cama de piedras" },
      },
      {
        title: "Sifón de campana",
        longDescription:
          "Construye el mecanismo que permite el llenado y vaciado automático de la cama.",
        shortDescription: ["Armar sifón"],
        image: { src: "aqua3.jpg", alt: "Sifón PVC" },
      },
      {
        title: "Ciclado del nitrógeno",
        longDescription:
          "Espera 2 semanas para que las bacterias conviertan el amoníaco en nitratos.",
        shortDescription: ["Medir pH", "Esperar"],
        image: { src: "aqua4.jpg", alt: "Kit de test" },
      },
    ],
  },
  {
    id: 20,
    title: "Lámpara de Botella de Vidrio",
    descripcion:
    ...
    likes: 180,
    comments: 10,
    author: { name: "Luz Eco", avatar: "https://i.pravatar.cc/150?u=luz" },
    cost: "20 MXN",
    difficulty: ProjectDifficulty.FACIL,
    completedProjects: 112,
    materialsId: [120, 121, 122],
    steps: [
      {
        title: "Corte de botella",
        longDescription:
          "Usa un cortador de botellas y choque térmico para separar la base.",
        shortDescription: ["Marcar", "Calentar", "Enfriar"],
        image: { src: "lamp1.jpg", alt: "Botella cortada" },
      },
      {
        title: "Pulido",
        longDescription:
          "Lija los bordes con lija de agua para evitar cortes y dejar un acabado suave.",
        shortDescription: ["Lijar bordes"],
        image: { src: "lamp2.jpg", alt: "Borde pulido" },
      },
      {
        title: "Instalación eléctrica",
        longDescription: "Monta el portalámparas y el cableado de seguridad.",
        shortDescription: ["Cablear", "Aislar"],
        image: { src: "lamp3.jpg", alt: "Socket instalado" },
      },
      {
        title: "Ensamblado final",
        longDescription:
          "Coloca la bombilla LED y fija la botella a la base de madera.",
        shortDescription: ["Probar luz"],
        image: { src: "lamp4.jpg", alt: "Lámpara encendida" },
      },
    ],
  },
  {
    id: 21,
    title: "Filtro de Agua de Emergencia",
    ...
    materialsId: [130, 131, 132],
    steps: [
      {
        title: "Capa de algodón",
        longDescription:
          "Coloca algodón en el cuello de una botella invertida como primera barrera.",
        shortDescription: ["Compactar"],
        image: { src: "filter1.jpg", alt: "Algodón" },
      },
      {
        title: "Carbón activado",
        longDescription:
          "Añade una capa de carbón triturado para eliminar químicos y olores.",
        shortDescription: ["Machacar carbón"],
        image: { src: "filter2.jpg", alt: "Carbón negro" },
      },
      {
        title: "Arena y grava",
        longDescription:
          "Intercala capas de arena fina y grava para filtrar partículas grandes.",
        shortDescription: ["Rellenar capas"],
        image: { src: "filter3.jpg", alt: "Capas visibles" },
      },
      {
        title: "Filtrado inicial",
        longDescription:
          "Vierte agua y descarta los primeros litros hasta que salga transparente.",
        shortDescription: ["Limpiar filtro"],
        image: { src: "filter4.jpg", alt: "Agua clara" },
      },
    ],
  },
  {
    id: 22,
    title: "Cercado Vivo de Cactus",
    descripcion:
    ...
    category: Category.BIODIVERSIDAD,
    subCategorys: [],
    constructionTime: "2 días",
    likes: 130,
    comments: 7,
    author: { name: "Rancho", avatar: "https://i.pravatar.cc/150?u=rancho" },
    cost: "Bajo",
    difficulty: ProjectDifficulty.MEDIO,
    completedProjects: 20,
    materialsId: [140, 141],
    steps: [
      {
        title: "Selección de esquejes",
        longDescription:
          "Corta brazos de cactus maduros y déjalos cicatrizar por 3 días.",
        shortDescription: ["Cortar", "Secar"],
        image: { src: "fence1.jpg", alt: "Cactus cortado" },
      },
      {
        title: "Zanja de siembra",
        longDescription:
          "Realiza una pequeña zanja de 20cm de profundidad siguiendo la línea de la cerca.",
        shortDescription: ["Cavar"],
        image: { src: "fence2.jpg", alt: "Zanja en tierra" },
      },
      {
        title: "Plantación",
        longDescription:
          "Coloca los cactus muy juntos entre sí para crear una barrera impenetrable.",
        shortDescription: ["Enterrar"],
        image: { src: "fence3.jpg", alt: "Cactus plantados" },
      },
      {
        title: "Sujeción",
        longDescription:
          "Coloca tutores de madera temporales mientras las raíces se establecen.",
        shortDescription: ["Atar tutores"],
        image: { src: "fence4.jpg", alt: "Cerca terminada" },
      },
    ],
  },
  {
    id: 23,
    title: "Mueble de Cartón Reciclado",
    descripcion:
    ...
    likes: 255,
    comments: 18,
    author: { name: "Papelero", avatar: "https://i.pravatar.cc/150?u=pape" },
    cost: "Gratis",
    difficulty: ProjectDifficulty.MEDIO,
    ...
    steps: [
      {
        title: "Triplicado de láminas",
        longDescription:
          "Pega tres capas de cartón corrugado para crear paneles de alta resistencia.",
        shortDescription: ["Pegar", "Prensar"],
        image: { src: "carton1.jpg", alt: "Cartón grueso" },
      },
      {
        title: "Corte de encastres",
        longDescription:
          "Usa un bisturí para cortar las ranuras donde se unirán las piezas sin pegamento.",
        shortDescription: ["Cortar ranuras"],
        image: { src: "carton2.jpg", alt: "Piezas cortadas" },
      },
      {
        title: "Ensamblado",
        longDescription:
          "Une las piezas mediante presión siguiendo el orden de la base hacia arriba.",
        shortDescription: ["Encajar"],
        image: { src: "carton3.jpg", alt: "Estructura armada" },
      },
      {
        title: "Acabado final",
        longDescription:
          "Forra con papel periódico o pintura ecológica para proteger de la humedad.",
        shortDescription: ["Pintar"],
        image: { src: "carton4.jpg", alt: "Estantería final" },
      },
    ],
  },
];
