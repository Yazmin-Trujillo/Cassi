...
export default async function Proyecto({ params }: ProyectoType) {
  ...
  return (
    <main className="flex flex-col gap-16">
      <section id="hero-project" className="bg-green-100!">
        <div className="max-w-7xl mx-auto p-6">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-12 items-center md:max-h-[400px]">
            <div className="">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-gray-600">Nivel: Intermedio</span>
              </div>
              <h1 className="text-4xl font-bold text-gray-900 mb-6">
                Sistema de Compostaje Urbano Sostenible
              </h1>
              <p className="text-lg text-gray-600 mb-8">
                Aprende a crear tu propio sistema de compostaje casero
                utilizando materiales reciclados. Reduce residuos orgánicos y
                crea fertilizante natural para tus plantas.
              </p>
              <div className="flex items-center space-x-6">
                <div className="flex items-center space-x-2">
                  <i className="pi pi-clock text-primary"></i>
                  <span className="text-gray-600">3-4 horas</span>
                </div>
                <div className="flex items-center space-x-2">
                  <i className="pi pi-dollar text-primary"></i>
                  <span className="text-gray-600">$25-40 USD</span>
                </div>
                <div className="flex items-center space-x-2">
                  <i className="pi pi-users text-primary"></i>
                  <span className="text-gray-600">1,247 completados</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Toma el contenedor plástico y realiza orificios de ventilación
                  en los laterales y la base. Estos permitirán la circulación de
                  aire necesaria para el proceso de compostaje.
                </p>
            ...
            <div className="flex flex-col md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Agrega una capa base de material seco como hojas secas, papel
                  triturado o cartón. Esta capa ayudará a absorber la humedad y
                  proporcionará carbono al compost.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    <i className="pi pi-check text-secondary mr-2"></i>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  "Perfecto para mi balcón pequeño. En 4 meses ya tengo compost
                  para mis plantas. Los pasos fueron muy claros y fáciles de
                  seguir."
                </p>
            ...
            <div className="bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  "Lo adapté para usar en la cocina. Sin olores y muy eficiente.
                  Mis hierbas nunca habían crecido tan bien con este compost
                  casero."
                </p>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-1">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    <h4 className="font-semibold text-gray-900">Pedro Silva</h4>
              ...
              <div className="ml-14 mt-4 space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-600">
                    Yo vivo en zona muy húmeda y funciona perfecto. Solo agrega
                    más material seco y revuelve más frecuentemente. También
                    puedes hacer más orificios de ventilación.
                  </p>
                </div>
              </div>
            </div>
