...
const Card = ({
  ...
  return (
    <div
      id="card"
      className="overflow-hidden shadow-lg! hover:shadow-2xl! min-w-2xs group p-card p-component"
    >
      <div className="p-card-header">
        <div className="h-64 overflow-hidden relative">
          ...
          <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-sm font-semibold text-primary flex items-center space-x-1">
            ...
            <span>{tiempoDeConstruccion}</span>
          </div>
        </div>
      </div>
      <div className="p-card-body" data-pc-section="body">
        <div className="p-card-title" data-pc-section="title">
          {titulo}
        </div>
        <div className="p-card-content" data-pc-section="content">
          <p className="text-xl line-clamp-3">{contenido}</p>
        </div>
