...
export const SeccionHero = (
  <section
    id="hero-section"
    className="max-w-[1500px] flex w-full items-center md:pt-16 md:pb-30 md:h-[720px]"
  >
    <div className="max-w-7xl mx-auto flex gap-16 items-center relative w-full md:px-8 xl:px-16">
      <div className="md:w-1/2 md:relative absolute bottom-0 left-0 right-0 z-1">
        <Card
          ...
          title={
            <>
              <div className="md:hidden text-3xl ">Aprende Sustentabilidad</div>
